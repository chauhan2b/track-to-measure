...
export const metadata: Metadata = {
  title: "Privacy Policy | TagSentry",
  description: "TagSentry's privacy policy and data handling practices",
};
    ...
    <div className="container py-10">
      <div className="flex flex-col space-y-6 max-w-3xl mx-auto">
        ...
        <section className="space-y-4">
          ...
          <p>
            TagSentry ("we", "our", or "us") is committed to protecting your
          ...
          <p>
            ...
            TagSentry, you acknowledge that you have read, understood, and agree
            to be bound by the terms described in this policy.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              and password. This information is used to identify you,
              authenticate your account, and provide access to our services.
            </p>
          </div>
          <div className="space-y-3">
            <h3 className="text-lg font-medium">Website Scanning Data</h3>
            <p>
              When you scan a website using our tools, we collect the URL and
              metadata related to the marketing tracking tags detected on that
              website. This information is used to generate reports and provide
              our core services.
            </p>
          </div>
          <div className="space-y-3">
            ...
            <p>
              ...
              features accessed, time spent on pages, actions taken, and other
              related metrics. This helps us improve our service and user
              experience.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              To process and fulfill your requests such as generating reports
            </li>
            <li>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              Right to restrict or object to our processing of your personal
              information
            </li>
        ...
        <section className="space-y-4">
          ...
          <div className="pt-2">
            ...
            <p className="mt-2">Email: privacy@tagsentry.com</p>
          </div>
        </section>
      </div>
    </div>
