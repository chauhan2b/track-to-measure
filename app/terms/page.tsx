...
export const metadata: Metadata = {
  title: "Terms of Service | TagSentry",
  description: "TagSentry's terms of service and usage agreement",
};
    ...
    <div className="container py-10">
      <div className="flex flex-col space-y-6 max-w-3xl mx-auto">
        ...
        <section className="space-y-4">
          ...
          <p>
            By accessing or using the TagSentry website and services
        ...
        <section className="space-y-4">
          ...
          <p>
            TagSentry provides tools for scanning websites for marketing
            tracking tags, generating reports, and accessing implementation
            guides. We reserve the right to modify, suspend, or discontinue the
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            when creating an account and to update your information to keep it
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              Use the Service to scan websites without proper authorization
            </li>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            are owned by TagSentry and are protected by international copyright,
        ...
        <section className="space-y-4">
          ...
          <p>
            By submitting, posting, or displaying content through the Service,
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            TagSentry be liable for any indirect, incidental, special,
        ...
        <section className="space-y-4">
          ...
          <p>
            TagSentry does not warrant that: (a) the Service will function
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            [Your Jurisdiction]. TagSentry and yourself irrevocably consent that
            the courts of [Your Jurisdiction] shall have exclusive jurisdiction
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            the top of these Terms. Your continued use of the Service after such
        ...
        <section className="space-y-4">
          ...
          <div className="pt-2">
            <p className="font-medium">TagSentry</p>
            <p>123 Market St</p>
            <p>San Francisco, CA 94105</p>
            <p className="mt-2">Email: legal@tagsentry.com</p>
          </div>
        </section>
      </div>
    </div>
